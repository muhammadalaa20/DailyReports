...
const NewReportForm = ({ isVisible, setIsVisible }) => {
  ...
  const handleSaveReport = async () => {
    ...
    const response = await fetch("http://172.17.40.200:8070/dct/reports", {
      method: "POST",
              ...
              <div key={index} className="flex flex-col space-y-2">
                ...
                {task.category === "Engineers" ?
                  ...
                  >
                    ...
                    <option value="Mohamed Abdel Mawgoud">Mohamed Abdel Mawgoud</option>
                    <option value="Mahmoud Mohsen">Mahmoud Mohsen</option>
                    <option value="Mohamed Alaa Heikal">Mohamed Alaa Heikal</option>
                  ...
                  >
                    <option value="">Select A Name</option>
                    <option value="Abd Elaziz Mostafa">Abd Elaziz Mostafa</option>
                    <option value="Saed Ibrahim">Saed Ibrahim</option>
                    <option value="Ashraf Elgendy">Ashraf Elgendy</option>
                    <option value="Ahmed Nader">Ahmed Nader</option>
                    <option value="Ahmed Zaki">Ahmed Zaki</option>
                    <option value="Mohamed Hassan">Mohamed Hassan</option>
                    <option value="Ahmed Farghaly">Ahmed Farghaly</option>
                    <option value="Ahmed Ibrahim">Ahmed Ibrahim</option>
                  </select> : <input
                    type="text"
